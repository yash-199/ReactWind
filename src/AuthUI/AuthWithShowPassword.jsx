...
const AuthWithShowPassword = () => {
    ...
    return (
        <div>
            <h1 className="font-semibold text-2xl my-10">Authentication Form With Show/Hide Password</h1>
                        ...
                        <div className='w-1/3 mx-auto p-6 sm:p-8 flex flex-col items-center'>
                            ...
                            <form className='w-full max-w-sm space-y-4'>
                                ...
                                <div className="flex items-center gap-3 px-4 py-2 rounded-full bg-[#333A5C]">
                                    ...
                                    />
                                    {eyeOpen ? (
                                        <RiEyeCloseLine onClick={() => setEyeOpen(false)} className='cursor-pointer' />
                                    ) : (
                                        <GiSemiClosedEye onClick={() => setEyeOpen(true)} className='cursor-pointer' />
                                    )}
                                </div>
                            </form>
...
export default AuthWithShowPassword