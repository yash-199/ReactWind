...
const AccordionwithArrow = () => {
                    ...
                    {faqs.map((faq, index) => (
                        ...
                        >
                            <div className="flex justify-between items-center cursor-pointer">
                                ...
                                <div className='w-10'>
                                    {openAccordion === index ? (
                                        <BiSolidUpArrow className="text-black bg-gray-200 p-2 text-3xl rounded-xl" />
                                    ) : (
                                        <BiSolidDownArrow className="text-black bg-gray-200 p-2 text-3xl rounded-xl" />
                                    )}
                                </div>
                            </div>
                            {/* Conditionally Render Answer with Animated Height */}
    ...
    return (
        <div>
            <h1 className='font-bold my-10 text-3xl'>Accordion with Up & Down Arrow</h1>
