...
import ContentCardWAuthorImage from "../../CardUI/ContentCardWAuthorImage"
    ...
    return (
        <div className="hide-scrollbar w-10/12 mx-auto pt-20 text-white">
            <div className='mx-auto text-center'>
                <h1 className="mt-10 text-white mb-6 text-center text-4xl font-semibold leading-relaxed">ReCom Card UI Build Faster! </h1>
