import Banner from "../../BannerUI/Banner"
import InteractiveBanner from "../../BannerUI/InteractiveBanner"
import { NavLink } from 'react-router-dom'
const AppUIBanner = () => {
    return (
        <div className="hide-scrollbar w-10/12 mx-auto pt-20">
            <div className='mx-auto text-center'>
                <h1 className="mt-10 text-white mb-6 text-center text-4xl font-semibold leading-relaxed">ReCom Banner UI Build Faster! </h1>
