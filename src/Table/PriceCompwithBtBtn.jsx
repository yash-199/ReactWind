                    ...
                    {showPreview ? (
                        <table className='w-full rounded-lg'>
                            <tr className='bg-[#3B82F6] text-white rounded-lg'>
                                <th className='py-4 text-lg font-medium'>Features</th>
                                <th className='py-4 text-lg font-medium'>Free Pack <br /> ₹0.00/<span className='text-sm font-normal'>*mo</span></th>
                                <th className='py-4 text-lg font-medium'>Starter Pack <br /> ₹10.00/<span className='text-sm font-normal'>*mo</span></th>
                                <th className='py-4 text-lg font-medium'>Pro Pack <br />₹20.00/<span className='text-sm font-normal'>*mo</span></th>
                                <th className='py-4 text-lg font-medium'>Ultimate Pack<br />₹30.00/<span className='text-sm font-normal'>*mo</span></th>
                                <th className='py-4 text-lg font-medium'>Enterprise Pack<br />₹40.00/<span className='text-sm font-normal'>*mo</span></th>
                            </tr>
                            <tr className='bg-[#FFFFFF] hover:bg-slate-300 text-black duration-150 transition-all'>
                                ...
                                <td className='py-4 text-center text-lg '>Contact</td>
                            </tr>
                            ...
                            <tr>
                                <td className='py-4 text-center text-lg '></td>
...
export default PriceCompwithBtBtn